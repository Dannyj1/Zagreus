...
// Some of these benchmark positions are taken from Stockfish's benchmark.cpp: https://github.com/official-stockfish/Stockfish/blob/master/src/benchmark.cpp
