...
namespace Zagreus {
int midgamePawnTable[64] = {0,   0,   0,  0,   0,   0,  0,  0,   89,  115, 57, 97, 72, 113, 37, -2,
                            -6,  7,   39, 28,  42,  57, 20, -13, -12, 5,   0,  25, 27, 15,  14, -10,
                            -41, -14, -3, 21,  23,  9,  0,  -27, -19, -6,  -4, 2,  0,  0,   6,  -17,
                            -22, 13,  -7, -11, -12, 4,  25, -13, 0,   0,   0,  0,  0,  0,   0,  0};
int endgamePawnTable[64] = {
    0,  0,  0,   0,  0,  0, 0,  0,  174, 159, 150, 131, 147, 121, 169, 187, 94, 97, 86, 67, 42, 59,
    80, 77, 33,  26, 22, 1, -3, 5,  7,   26,  14,  10,  -7,  -10, -12, -17, -3, -1, 4,  10, 0,  12,
    13, -2, -10, 0,  11, 5, 17, 23, 18,  4,   -8,  0,   0,   0,   0,   0,   0,  0,  0,  0};

int midgameKnightTable[64] = {-167, -88, -41, -45, 58,   -90, -14, -110, -65, -33, 73,  43,  32,
                              73,   0,   -21, -38, 53,   35,  64,  78,   110, 61,  39,  -2,  15,
                              16,   34,  38,  38,  15,   23,  -6,  7,    18,  19,  23,  18,  18,
                              -6,   -27, 2,   11,  12,   17,  10,  9,    -18, -15, -41, -10, 16,
                              16,   8,   -5,  -8,  -100, -15, -46, -28,  -19, -21, -13, -26};
int endgameKnightTable[64] = {-55, -41, -17, -26, -33, -23, -63, -98, -26, -5,  -22, -6,  -5,
                              -12, -19, -50, -19, -23, 13,  9,   -4,  -16, -21, -41, -12, 13,
                              25,  21,  20,  5,   11,  -14, -9,  -5,  15,  26,  18,  16,  0,
                              -12, -21, 0,   -17, 16,  10,  -14, -30, -16, -39, -15, -6,  -4,
                              -9,  -25, -23, -39, -27, -35, -13, -11, -12, -12, -42, -65};

int midgameBishopTable[64] = {-26, 1,  -72, -35, -29, -43, 0,  -5,  -18, 5,  -22, -7, 22,
                              46,  10, -24, -5,  33,  39,  27, 27,  48,  26, 6,   -6, 0,
                              9,   26, 25,  14,  3,   -12, -4, 3,   0,   24, 28,  3,  7,
                              -3,  9,  20,  18,  8,   17,  30, 12,  20,  11, 37,  17, 13,
                              16,  23, 47,  -1,  -20, -4,  0,  -16, -3,  0,  -23, -12};
int endgameBishopTable[64] = {-10, -21, -4,  -3,  -10, -9,  -22, -21, -3,  -8,  7,  -8, -9,
                              -27, -9,  -11, 8,   -12, -1,  -9,  0,   5,   -8,  3,  -5, 4,
                              3,   3,   12,  0,   0,   -1,  -10, 1,   8,   16,  3,  0,  -9,
                              -11, -5,  -2,  15,  22,  7,   10,  -4,  -13, -12, -5, 0,  8,
                              8,   -11, -7,  -25, -18, -10, -7,  2,   -8,  -9,  -3, -12};

int midgameRookTable[64] = {31,  41,  27,  53,  62,  11,  30,  40,  16,  12,  57,  49,  68,
                            57,  21,  38,  0,   15,  22,  37,  31,  44,  52,  13,  -15, -8,
                            6,   26,  15,  30,  -2,  -14, -33, -24, -22, -10, 5,   -12, 4,
                            -28, -42, -23, -14, -12, 1,   -1,  -8,  -27, -46, -13, -22, -10,
                            -1,  -5,  -2,  -52, -4,  -11, -1,  0,   9,   4,   -12, -9};
int endgameRookTable[64] = {13, 11, 13, 17, 9,  16,  8,   2,   4,  10, 7,  6,  -10, 2,   15,  0,
                            10, 3,  8,  5,  12, -2,  -4,  -1,  2,  6,  12, 1,  -6,  0,   -1,  7,
                            0,  8,  5,  2,  -7, -10, -10, -13, -6, 0,  -7, 5,  -8,  -13, -11, -11,
                            -7, -5, 0,  0,  -8, -10, -4,  7,   0,  2,  0,  -6, -9,  -1,  6,   -9};

int midgameQueenTable[64] = {-26, -1,  31,  14, 55,  43,  43,  36,  -15, -48, -6,  -9,  -24,
                             42,  1,   36,  -5, -5,  5,   4,   28,  41,  41,  36,  -13, -19,
                             -18, -18, -11, 6,  -11, 0,   -16, -21, -17, -18, -17, -6,  2,
                             -3,  -17, 4,   -3, -10, -4,  -7,  6,   2,   -24, 0,   8,   10,
                             12,  12,  13,  4,  -4,  -18, -12, 7,   7,   -12, -21, -25};
int endgameQueenTable[64] = {-6, 21,  22,  26,  23,  18,  7,   15,  -9, 20,  33,  35,  49,
                             18, 19,  -4,  -17, 10,  14,  52,  49,  25, 17,  0,   6,   29,
                             23, 52,  51,  36,  56,  32,  -4,  32,  18, 44,  29,  34,  38,
                             18, -15, -27, 18,  4,   3,   17,  5,   0,  -19, -20, -29, -2,
                             0,  -25, -27, -32, -34, -28, -25, -30, 0,  -27, -16, -26};

int midgameKingTable[64] = {-65, 22,  16,  -15, -56, -34, 2,   13,  28,  -1,  -20, -6,  -7,
                            -3,  -37, -29, -8,  24,  1,   -15, -19, 5,   21,  -22, -17, -21,
                            -12, -27, -30, -25, -12, -36, -48, 0,   -28, -37, -47, -46, -31,
                            -52, -15, -15, -20, -53, -45, -24, -9,  -26, 15,  16,  -21, -70,
                            -59, -24, 10,  9,   4,   20,  -24, -9,  -9,  -37, 10,  0};
int endgameKingTable[64] = {-74, -35, -18, -18, -11, 15,  4,   -17, -12, 16,  13,  17, 17,
                            38,  23,  10,  9,   17,  23,  15,  20,  44,  43,  13,  -8, 20,
                            24,  27,  25,  31,  28,  3,   -16, -3,  19,  25,  23,  25, 12,
                            -13, -16, 0,   17,  20,  24,  25,  15,  -8,  -25, -15, 8,  28,
                            24,  13,  -5,  -28, -53, -39, -25, -11, -32, -5,  -28, -56};
