...
int mg_pawn_table[64] = {
    0, 0, 0, 0, 0, 0, 0, 0,
    96, 132, 59, 95, 68, 123, 31, -13,
    -7, 6, 25, 31, 64, 55, 25, -21,
    -15, 13, 5, 20, 22, 12, 16, -25,
    -27, -2, -5, 13, 17, 6, 10, -26,
    -25, -4, -3, -9, 5, 3, 35, -11,
    -32, 3, -19, -22, -13, 28, 41, -18,
    0, 0, 0, 0, 0, 0, 0, 0
};

// Midgame knight PST
int mg_knight_table[64] = {
    -167, -89, -34, -49, 61, -97, -16, -107,
    -73, -41, 72, 36, 23, 62, 7, -17,
    -47, 60, 36, 65, 84, 128, 73, 44,
    -9, 17, 19, 53, 37, 69, 18, 22,
    -13, 4, 16, 13, 28, 19, 21, -8,
    -23, -9, 13, 10, 19, 19, 25, -16,
    -29, -53, -12, -2, -1, 18, -14, -19,
    -105, -20, -58, -33, -17, -28, -19, -23
};

// Midgame bishop PST
int mg_bishop_table[64] = {
    -29, 4, -81, -37, -25, -43, 7, -8,
    -26, 16, -18, -13, 30, 59, 19, -47,
    -16, 37, 43, 39, 35, 50, 37, -2,
    -4, 5, 19, 50, 37, 36, 7, -2,
    -6, 13, 13, 26, 34, 12, 10, 4,
    0, 15, 15, 15, 14, 27, 18, 10,
    4, 16, 16, 1, 9, 21, 35, 1,
    -33, -3, -10, -21, -13, -11, -39, -21
};

// Midgame rook PST
int mg_rook_table[64] = {
    29, 42, 32, 50, 63, 9, 31, 41,
...
int mg_queen_table[64] = {
    ...
    -14, 2, -11, -2, -5, 2, 14, 5,
    -35, -8, 11, 2, 8, 15, -3, 1,
    -1, -18, -9, 14, -15, -25, -31, -50
};

// Midgame king PST
int mg_king_table[64] = {
    -65, 23, 16, -15, -58, -34, 1, 13,
    29, -1, -20, -7, -8, -4, -38, -29,
