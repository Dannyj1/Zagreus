...
namespace Zagreus {
int midgamePawnTable[64] = {0, 0, 0, 0, 0, 0, 0, 0, 75, 83, 54, 93, 77, 103, 36, 19, 20, 15, 53, 27,
                            21, 58, 23, 0, 17, 11, 10, 28, 20, 15, 14, 14, 0, 0, 11, 26, 27, 11, 0,
                            0, 12, 3, 7, 20, 18, 10, 2, 7, 21, 31, 13, 15, 17, 21, 41, 17, 0, 0, 0,
                            0, 0, 0, 0, 0};
int endgamePawnTable[64] = {0, 0, 0, 0, 0, 0, 0, 0, 206, 190, 183, 158, 158, 173, 206, 228, 102,
                            107, 82, 62, 58, 60, 116, 124, 20, 22, 5, 5, 1, 4, 23, 21, 15, 17, 7, 3,
                            11, 7, 16, 16, 6, 8, 7, 8, 15, 2, 4, 9, 11, 11, 25, 27, 25, 21, 11, 13,
                            0, 0, 0, 0, 0, 0, 0, 0};

int midgameKnightTable[64] = {0, 4, 0, 0, 50, 0, 0, 0, 0, 4, 79, 82, 56, 81, 2, 0, 0, 56, 67, 73,
                              103, 86, 74, 39, 39, 51, 61, 60, 63, 68, 51, 56, 23, 34, 50, 54, 57,
                              51, 35, 22, 0, 22, 32, 33, 32, 30, 22, 0, 11, 4, 7, 45, 45, 27, 11,
                              11, 0, 0, 0, 4, 6, 2, 4, 0};
int endgameKnightTable[64] = {0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, 20, 14, 0, 0, 0, 0, 0, 22, 21, 12,
                              17, 0, 3, 16, 28, 28, 52, 54, 29, 26, 13, 13, 24, 34, 43, 27, 26, 19,
                              13, 1, 9, 9, 36, 34, 0, 10, 2, 0, 4, 12, 7, 4, 9, 13, 2, 0, 3, 10, 12,
                              3, 7, 1, 0};

int midgameBishopTable[64] = {0, 0, 0, 2, 0, 0, 0, 15, 0, 1, 0, 0, 0, 19, 1, 0, 17, 24, 52, 33, 31,
                              59, 22, 9, 3, 27, 20, 42, 50, 24, 43, 3, 11, 25, 33, 54, 55, 35, 24,
                              4, 23, 30, 33, 25, 30, 40, 24, 34, 35, 47, 31, 33, 34, 38, 47, 14, 9,
                              0, 7, 0, 4, 8, 11, 9};
int endgameBishopTable[64] = {0, 0, 1, 1, 0, 0, 3, 10, 0, 2, 12, 12, 0, 4, 2, 0, 6, 12, 12, 7, 15,
                              3, 0, 3, 8, 23, 6, 14, 21, 15, 17, 4, 3, 12, 34, 17, 10, 29, 6, 0, 10,
                              10, 30, 35, 28, 22, 1, 0, 0, 10, 8, 25, 21, 1, 11, 4, 0, 0, 11, 16, 4,
                              1, 1, 0};

int midgameRookTable[64] = {36, 54, 22, 47, 56, 24, 52, 36, 10, 1, 60, 42, 70, 35, 15, 41, 24, 23,
                            39, 49, 32, 45, 51, 9, 14, 4, 8, 43, 25, 37, 0, 3, 2, 12, 1, 5, 11, 5,
                            3, 2, 0, 10, 7, 10, 15, 11, 0, 0, 0, 4, 10, 11, 10, 0, 8, 0, 15, 11, 28,
                            26, 30, 27, 19, 13};
int endgameRookTable[64] = {12, 9, 13, 20, 6, 17, 3, 21, 18, 20, 11, 9, 9, 16, 36, 9, 15, 11, 6, 6,
                            16, 8, 10, 11, 17, 15, 10, 0, 8, 7, 13, 10, 13, 13, 10, 19, 21, 12, 9,
                            1, 8, 12, 8, 5, 9, 3, 3, 0, 0, 15, 0, 7, 7, 16, 12, 0, 13, 18, 22, 10,
                            15, 21, 10, 15};

int midgameQueenTable[64] = {33, 6, 46, 27, 59, 41, 51, 34, 0, 0, 19, 0, 0, 31, 0, 8, 19, 22, 26,
                             14, 21, 28, 40, 22, 22, 15, 1, 3, 3, 13, 0, 4, 19, 21, 0, 10, 1, 0, 22,
                             18, 2, 20, 25, 16, 14, 9, 14, 11, 10, 20, 24, 25, 30, 20, 29, 28, 10,
                             10, 9, 38, 33, 6, 5, 16};
int endgameQueenTable[64] = {40, 23, 43, 25, 38, 35, 28, 26, 23, 2, 61, 64, 27, 17, 11, 7, 19, 21,
                             14, 58, 53, 40, 24, 16, 15, 38, 31, 48, 52, 28, 64, 52, 33, 47, 36, 36,
                             30, 47, 59, 35, 13, 10, 34, 25, 18, 48, 19, 14, 13, 18, 6, 32, 19, 11,
                             16, 5, 19, 13, 0, 1, 8, 13, 17, 2};

int midgameKingTable[64] = {4, 24, 21, 9, 4, 5, 9, 12, 17, 5, 22, 10, 2, 15, 10, 0, 2, 50, 12, 12,
                            0, 18, 52, 1, 0, 21, 7, 17, 4, 11, 10, 1, 1, 7, 1, 2, 6, 8, 6, 1, 1, 20,
                            8, 0, 0, 7, 13, 3, 39, 40, 2, 0, 0, 0, 24, 10, 3, 31, 0, 31, 20, 0, 53,
                            0};
int endgameKingTable[64] = {5, 0, 3, 0, 3, 0, 13, 0, 0, 16, 27, 24, 27, 46, 40, 0, 1, 41, 48, 41,
                            36, 53, 44, 6, 0, 31, 47, 45, 46, 51, 30, 5, 0, 26, 48, 50, 43, 44, 17,
                            0, 0, 28, 41, 45, 44, 42, 27, 1, 0, 26, 45, 32, 30, 35, 22, 0, 0, 0, 10,
                            10, 0, 1, 0, 0};
