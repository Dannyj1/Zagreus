...
namespace Zagreus {
int midgamePawnTable[64] = {4, 4, 4, 4, 4, 4, 4, 4, 37, 47, 40, 80, 65, 82, 24, 10, -9, -1, 38, 12,
                            17, 40, 0, -16, -13, -2, 5, 23, 21, 4, 4, -11, -38, -13, 0, 20, 19, 3,
                            -13, -25, -19, -4, -5, 0, 1, -4, -4, -18, -16, 15, -5, -10, -9, 1, 18,
                            -10, 4, 4, 4, 4, 4, 4, 4, 4};
int endgamePawnTable[64] = {4, 4, 4, 4, 4, 4, 4, 4, 161, 103, 115, 121, 139, 81, 150, 199, 90, 89,
                            76, 74, 44, 46, 80, 77, 36, 33, 5, -2, -4, 12, -4, 26, 18, 4, -3, -7,
                            -9, -1, -5, 6, 7, 10, 14, 24, 23, 9, 0, 5, 12, 3, 28, 32, 26, 18, -9, 2,
                            4, 4, 4, 4, 4, 4, 4, 4};

int midgameKnightTable[64] = {-172, -88, -56, -48, 40, -57, -22, -136, -40, -15, 51, 48, 20, 43,
                              -18, -31, -29, 37, 14, 59, 71, 42, 50, 37, 14, 11, 14, 34, 37, 18, 16,
                              40, -1, 3, 21, 20, 26, 22, 22, 1, -24, 7, 16, 18, 20, 15, 11, -14, 0,
                              -13, -5, 27, 25, 17, 10, 13, -71, -9, -24, -10, -7, -11, -7, -30};
int endgameKnightTable[64] = {-44, -54, -44, -21, -43, -26, -59, -76, -37, -6, -52, -22, -29, -12,
                              -25, -17, -13, -30, 13, -7, -2, -18, -35, -49, 4, 23, 33, 33, 26, 25,
                              17, -10, 2, 14, 9, 31, 15, 12, -18, -5, 0, -10, -25, 16, 15, -17, -28,
                              -12, -24, -16, 1, -17, -11, -34, -22, -45, -23, -16, 2, -6, -6, 3,
                              -23, -54};

int midgameBishopTable[64] = {-33, -11, -45, -33, -39, -40, -10, -10, -55, -13, -39, 0, 0, 10, 0,
                              -41, 0, 10, 16, 12, -5, 6, 12, 12, -15, 4, -10, 9, 20, -10, 17, -20,
                              -9, -6, 4, 29, 36, 9, 0, -11, 17, 23, 26, 12, 19, 33, 14, 30, 23, 50,
                              24, 23, 22, 26, 53, 5, 11, -10, 5, -14, 10, 9, -8, 10};
int endgameBishopTable[64] = {-1, -44, 2, 1, -20, 1, -57, 0, -10, -20, -1, -3, -16, -42, -25, 0, 7,
                              -13, -15, -41, -8, -4, -17, -16, -1, 16, 1, 14, 13, -15, -7, -5, -25,
                              11, 16, 13, -5, 9, -2, 1, 1, -17, 20, 29, 11, 0, 2, -15, -12, -8, 2,
                              9, 10, -17, -9, -36, -15, -12, 6, 23, -3, 0, 12, -13};

int midgameRookTable[64] = {29, 45, 33, 50, 71, 1, 32, 44, 1, -13, 43, 19, 45, 12, -13, 13, 19, 11,
                            11, 19, 24, 20, 31, -10, -7, 0, -4, 26, 12, 12, 0, -11, -25, -28, -31,
                            -27, -15, -20, -29, -28, -32, -19, -23, -7, -5, 0, 1, -24, -44, -5, -11,
                            4, -10, -15, -12, -31, 0, -9, 9, 10, 15, 10, -4, -6};
int endgameRookTable[64] = {1, 12, 39, 29, 5, 0, 0, -9, 6, 20, 22, 13, -16, 5, 22, -8, 8, 3, 4, 7,
                            19, -8, -5, -6, -4, -4, 25, -6, -8, 10, 7, 19, 2, 12, 3, -3, 3, -4, -6,
                            -19, -2, 15, 7, 5, 0, -13, -19, -3, -4, -4, 7, -3, 5, -4, 7, 8, 0, 8, 8,
                            0, -6, 6, 9, 4};

int midgameQueenTable[64] = {-31, -29, 9, 9, 39, 13, 5, -6, -33, -63, -46, -46, -58, 0, -45, -6, -5,
                             -6, -14, -15, 19, -8, 23, 10, 9, -16, -27, -22, -34, -8, -22, 0, -2,
                             -12, -14, -10, -18, -3, 0, 1, -14, 9, 12, -3, 2, -5, 10, 0, 0, 8, 14,
                             16, 20, 15, 20, 14, 9, 4, 2, 22, 18, 4, -4, 4};
int endgameQueenTable[64] = {0, 7, 11, 5, 8, -18, -18, 10, 11, 32, 28, 35, 22, -20, 21, -14, -1, 22,
                             9, 66, 44, 13, 3, -4, 0, 53, 40, 41, 38, 5, 65, 31, 18, 41, 22, 57, 43,
                             30, 43, 10, 3, -23, 29, 21, 16, 44, 2, 0, -4, -18, -1, 20, -7, -22,
                             -32, -14, -20, -14, -23, -10, -11, -17, -2, 0};

int midgameKingTable[64] = {-75, 32, 20, -10, -76, -29, 6, 2, 17, -12, -23, -3, -3, 1, -32, -35, -1,
                            30, -9, -21, -17, 9, 5, -23, -14, -28, -21, -47, -48, -61, -14, -36,
                            -58, -13, -48, -33, -71, -56, -38, -53, -6, -24, -27, -74, -66, -26, 0,
                            -22, 28, 27, -28, -78, -76, -49, 11, 11, 21, 19, -37, 0, -7, -35, 13,
                            0};
int endgameKingTable[64] = {-89, -26, -13, -13, -27, 19, 8, -27, -36, 1, -1, 31, 20, 47, 28, 3, 19,
                            31, 5, 24, 13, 45, 32, 13, -20, 0, 51, 19, 19, 5, 34, 0, -21, -17, 1,
                            38, 0, 35, 25, -25, -22, 4, 44, 41, 35, 28, 27, -6, -44, -12, 15, 45,
                            43, 39, -8, -30, -80, -37, -9, -30, -21, 2, -25, -65};
