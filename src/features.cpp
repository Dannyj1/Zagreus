...
namespace Zagreus {
int evalValues[124] = {82, 85, 437, 373, 468, 370, 595, 613, 1128, 1100, 10, 1, 6, 0, 4, 3, 5, 6, 5,
                       -6, -6, 0, -21, 30, -2, 3, -20, 7, -22, 4, -17, -14, 3, -15, -28, 34, -3, -6,
                       -11, 2, -6, -8, -8, -11, 12, 4, -8, -28, -25, -28, 9, -5, 0, -10, 45, 5, 15,
                       15, -20, 7, -4, 9, 30, 7, 0, -39, 17, -36, 9, 55, 28, 0, -14, -12, 10, 12,
                       -7, -1, -10, -4, -19, -15, -19, 24, -4, 50, -5, 0, -10, 0, -25, 0, -13, 6,
                       -25, 4, -12, 4, 13, -23, 10, 3, -44, 2, -23, 0, 0, -5, -16, -10, -21, 30,
                       -17, 3, 4, 0, 9, 0, -5, 0, 1, 0, -28, 0,};

int baseEvalValues[124] = {
    ...
    -3, // MIDGAME_KNIGHT_WEAK_SQUARE_PENALTY
    -3, // ENDGAME_KNIGHT_WEAK_SQUARE_PENALTY
    -3, // MIDGAME_BISHOP_WEAK_SQUARE_PENALTY
    -3, // ENDGAME_BISHOP_WEAK_SQUARE_PENALTY
    -4, // MIDGAME_ROOK_WEAK_SQUARE_PENALTY
    -4, // ENDGAME_ROOK_WEAK_SQUARE_PENALTY
    -5, // MIDGAME_QUEEN_WEAK_SQUARE_PENALTY
    -5, // ENDGAME_QUEEN_WEAK_SQUARE_PENALTY
    -5, // MIDGAME_PAWN_STORM_DISTANCE_3
    0, // ENDGAME_PAWN_STORM_DISTANCE_3
    -10, // MIDGAME_PAWN_STORM_DISTANCE_2
    0, // ENDGAME_PAWN_STORM_DISTANCE_2
    -25, // MIDGAME_PAWN_STORM_DISTANCE_1
    0, // ENDGAME_PAWN_STORM_DISTANCE_1
    -7, // MIDGAME_PAWN_SHIELD_NO_KING_PAWN
    0, // ENDGAME_PAWN_SHIELD_NO_KING_PAWN
    -10, // MIDGAME_PAWN_SHIELD_SEMI_OPEN_FILE
    0, // ENDGAME_PAWN_SHIELD_SEMI_OPEN_FILE
    -5, // MIDGAME_UNDEFENDED_PAWN_PENALTY
    -5, // ENDGAME_UNDEFENDED_PAWN_PENALTY
    -15, // MIDGAME_HANGING_PAWN_PENALTY
    -15, // ENDGAME_HANGING_PAWN_PENALTY
    -25, // MIDGAME_HANGING_MINOR_PIECE_PENALTY
    -25, // ENDGAME_HANGING_MINOR_PIECE_PENALTY
    -15, // MIDGAME_MINOR_PIECE_ATTACKED_BY_PAWN_PENALTY
    -15, // ENDGAME_MINOR_PIECE_ATTACKED_BY_PAWN_PENALTY
    -5, // MIDGAME_MINOR_PIECE_PAWN_THREAT_PENALTY
    -5, // ENDGAME_MINOR_PIECE_PAWN_THREAT_PENALTY
    -10, // MIDGAME_MAJOR_PIECE_NOT_DEFENDED_PENALTY
    -10, // ENDGAME_MAJOR_PIECE_NOT_DEFENDED_PENALTY
    -50, // MIDGAME_HANGING_MAJOR_PIECE_PENALTY
    -50, // ENDGAME_HANGING_MAJOR_PIECE_PENALTY
    -30, // MIDGAME_MAJOR_PIECE_ATTACKED_BY_PAWN_PENALTY
    -30, // ENDGAME_MAJOR_PIECE_ATTACKED_BY_PAWN_PENALTY
    -10, // MIDGAME_MAJOR_PIECE_THREATED_PENALTY
    -10, // ENDGAME_MAJOR_PIECE_THREATED_PENALTY
    5, // MIDGAME_PAWN_SPACE
    0, // ENDGAME_PAWN_SPACE
    10, // MIDGAME_STRONG_SPACE_SQUARES
    0, // ENDGAME_STRONG_SPACE_SQUARES
    -5, // MIDGAME_WEAK_SPACE_SQUARES_PENALTY
    0, // ENDGAME_WEAK_SPACE_SQUARES_PENALTY
    2, // MIDGAME_BEHIND_PAWN_SPACE
    0, // ENDGAME_BEHIND_PAWN_SPACE
    -15, // MIDGAME_KING_NEXT_TO_OPEN_FILE_PENALTY
