...
int evalValues[90] = {
    ...
    -5, // MIDGAME_PAWN_NOT_DEFENDED_PENALTY
    -5, // ENDGAME_PAWN_NOT_DEFENDED_PENALTY
    -3, // MIDGAME_PAWN_WEAK_SQUARE_PENALTY
    -3, // ENDGAME_PAWN_WEAK_SQUARE_PENALTY
};

int baseEvalValues[90] = {
    100, // MIDGAME_PAWN_MATERIAL
    100, // ENDGAME_PAWN_MATERIAL
    350, // MIDGAME_KNIGHT_MATERIAL
    350, // ENDGAME_KNIGHT_MATERIAL
