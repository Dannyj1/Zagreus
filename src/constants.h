...
static constexpr int ZOBRIST_CASTLING_WHITE_KINGSIDE_INDEX = ZOBRIST_SIDE_TO_MOVE_INDEX + 1;
static constexpr int ZOBRIST_CASTLING_WHITE_QUEENSIDE_INDEX = ZOBRIST_CASTLING_WHITE_KINGSIDE_INDEX + 1;
