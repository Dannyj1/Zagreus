...
enum EvalFeature {
    ...
    MIDGAME_PASSED_PAWN_CLOSE_TO_PROMOTION,
    ENDGAME_PASSED_PAWN_CLOSE_TO_PROMOTION,
    MIDGAME_PASSED_PAWN_DEFENDED,
    ENDGAME_PASSED_PAWN_DEFENDED,
    MIDGAME_BACKWARD_PAWN_PENALTY,
    ENDGAME_BACKWARD_PAWN_PENALTY,
    MIDGAME_PAWN_CONNECTED,
    ENDGAME_PAWN_CONNECTED,
    MIDGAME_MINOR_PIECE_NOT_DEFENDED_PENALTY,
    ENDGAME_MINOR_PIECE_NOT_DEFENDED_PENALTY,
    MIDGAME_KNIGHT_WEAK_SQUARE_PENALTY,
    ENDGAME_KNIGHT_WEAK_SQUARE_PENALTY,
    MIDGAME_BISHOP_WEAK_SQUARE_PENALTY,
    ENDGAME_BISHOP_WEAK_SQUARE_PENALTY,
    MIDGAME_ROOK_WEAK_SQUARE_PENALTY,
    ENDGAME_ROOK_WEAK_SQUARE_PENALTY,
    MIDGAME_QUEEN_WEAK_SQUARE_PENALTY,
    ENDGAME_QUEEN_WEAK_SQUARE_PENALTY,
    MIDGAME_PAWN_STORM_DISTANCE_3,
    ENDGAME_PAWN_STORM_DISTANCE_3,
    MIDGAME_PAWN_STORM_DISTANCE_2,
    ENDGAME_PAWN_STORM_DISTANCE_2,
    MIDGAME_PAWN_STORM_DISTANCE_1,
    ENDGAME_PAWN_STORM_DISTANCE_1,
    MIDGAME_PAWN_SHIELD_NO_KING_PAWN,
    ENDGAME_PAWN_SHIELD_NO_KING_PAWN,
    MIDGAME_KING_ON_SEMI_OPEN_FILE,
    ENDGAME_KING_ON_SEMI_OPEN_FILE,
    MIDGAME_UNDEFENDED_PAWN_PENALTY,
    ENDGAME_UNDEFENDED_PAWN_PENALTY,
    MIDGAME_HANGING_PAWN_PENALTY,
    ENDGAME_HANGING_PAWN_PENALTY,
    ...
    MIDGAME_PAWN_SPACE,
    ENDGAME_PAWN_SPACE,
    MIDGAME_STRONG_SPACE_SQUARES,
    ENDGAME_STRONG_SPACE_SQUARES,
    MIDGAME_WEAK_SPACE_SQUARES_PENALTY,
    ENDGAME_WEAK_SPACE_SQUARES_PENALTY,
    MIDGAME_BEHIND_PAWN_SPACE,
    ENDGAME_BEHIND_PAWN_SPACE,
    MIDGAME_KING_NEXT_TO_OPEN_FILE_PENALTY,
    ENDGAME_KING_NEXT_TO_OPEN_FILE_PENALTY,
};
...
static std::vector<const char*> evalFeatureNames = {
    ...
    "MIDGAME_PAWN_SHIELD_NO_KING_PAWN",
    "ENDGAME_PAWN_SHIELD_NO_KING_PAWN",
    "MIDGAME_PAWN_SHIELD_SEMI_OPEN_FILE",
    "ENDGAME_PAWN_SHIELD_SEMI_OPEN_FILE",
    "MIDGAME_UNDEFENDED_PAWN_PENALTY",
    "ENDGAME_UNDEFENDED_PAWN_PENALTY",
    "MIDGAME_HANGING_PAWN_PENALTY",
    "ENDGAME_HANGING_PAWN_PENALTY",
    ...
    "MIDGAME_MINOR_PIECE_ATTACKED_BY_PAWN_PENALTY",
    "ENDGAME_MINOR_PIECE_ATTACKED_BY_PAWN_PENALTY",
    "MIDGAME_MINOR_PIECE_THREATENED_PENALTY",
    "ENDGAME_MINOR_PIECE_THREATENED_PENALTY",
    "MIDGAME_MAJOR_PIECE_NOT_DEFENDED_PENALTY",
    "ENDGAME_MAJOR_PIECE_NOT_DEFENDED_PENALTY",
    "MIDGAME_HANGING_MAJOR_PIECE_PENALTY",
    "ENDGAME_HANGING_MAJOR_PIECE_PENALTY",
