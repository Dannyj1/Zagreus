...
namespace Zagreus {
    enum EvalFeature {
        ...
        MIDGAME_CENTER_CONTROL,
        ENDGAME_CENTER_CONTROL,
        MIDGAME_EXTENDED_CENTER_CONTROL,
        ENDGAME_EXTENDED_CENTER_CONTROL,
        ...
        MIDGAME_PAWN_ATTACK_NEAR_KING,
        ENDGAME_PAWN_ATTACK_NEAR_KING,
