...
enum EvalFeature {
    ...
    MIDGAME_PAWN_NOT_DEFENDED_PENALTY,
    ENDGAME_PAWN_NOT_DEFENDED_PENALTY,
    MIDGAME_KNIGHT_NOT_DEFENDED_PENALTY,
    ENDGAME_KNIGHT_NOT_DEFENDED_PENALTY,
    MIDGAME_BISHOP_NOT_DEFENDED_PENALTY,
    ENDGAME_BISHOP_NOT_DEFENDED_PENALTY,
    MIDGAME_ROOK_NOT_DEFENDED_PENALTY,
    ENDGAME_ROOK_NOT_DEFENDED_PENALTY,
    MIDGAME_QUEEN_NOT_DEFENDED_PENALTY,
    ENDGAME_QUEEN_NOT_DEFENDED_PENALTY,
    MIDGAME_PAWN_WEAK_SQUARE_PENALTY,
    ENDGAME_PAWN_WEAK_SQUARE_PENALTY,
