...
enum EvalFeature {
    ...
    MIDGAME_KNIGHT_REACHABLE_OUTPOST,
    ENDGAME_KNIGHT_REACHABLE_OUTPOST,
    MIDGAME_KNIGHT_DEFENDED_OUTPOST_BONUS,
    ENDGAME_KNIGHT_DEFENDED_OUTPOST_BONUS,
    MIDGAME_KNIGHT_OUTPOST_EDGE_PENALTY,
    ENDGAME_KNIGHT_OUTPOST_EDGE_PENALTY,
};
