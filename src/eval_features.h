...
// Mobility
#define MOBILITY_MIDGAME_KNIGHT_VALUE 4
#define MOBILITY_MIDGAME_BISHOP_VALUE 6
#define MOBILITY_MIDGAME_ROOK_VALUE 2
#define MOBILITY_MIDGAME_QUEEN_VALUE 4

#define MOBILITY_ENDGAME_KNIGHT_VALUE 2
#define MOBILITY_ENDGAME_BISHOP_VALUE 3
#define MOBILITY_ENDGAME_ROOK_VALUE 5
#define MOBILITY_ENDGAME_QUEEN_VALUE 6
