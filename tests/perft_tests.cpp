...
TEST_CASE("'r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -' at depth 4 == 4085603") {
    Zagreus::ZagreusEngine engine{};
    Zagreus::Bitboard bb{};
...
TEST_CASE("'8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -' at depth 6 == 11030083") {
    Zagreus::ZagreusEngine engine{};
    Zagreus::Bitboard bb{};
...
TEST_CASE("'r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1' at depth 5 == 15833292") {
    Zagreus::ZagreusEngine engine{};
    Zagreus::Bitboard bb{};
...
TEST_CASE("'r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1' at depth 5 == 15833292") {
    Zagreus::ZagreusEngine engine{};
    Zagreus::Bitboard bb{};
...
TEST_CASE("'r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10' at depth 4 == 3894594") {
    Zagreus::ZagreusEngine engine{};
    Zagreus::Bitboard bb{};
